        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                ...
                <b>
                    ...
                    <!-- Light Logo icon -->
                    <img src="{{asset('assets/images/logo-light-ico')}}n.png" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span>
                 ...
                 <!-- Light Logo text -->    
                 <img src="{{asset('assets/images/logo-light-tex')}}t.png" class="light-logo" alt="homepage" /></span> </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
