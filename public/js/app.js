...
Component.options.__file = "resources/assets/js/components/miniProduct.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5cffb051", Component.options)
  } else {
    hotAPI.reload("data-v-5cffb051", Component.options)
  }
...
var update = __webpack_require__(12)("9b321c62", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5cffb051\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./miniProduct.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5cffb051\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./miniProduct.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        try {
            for (var _iterator = this.product.categories[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    methods: {
        ...
        addSpinner: function addSpinner(e) {
            if (e.target.firstChild == null) e.target.className += ' fa-spin ';else e.target.firstChild.className += ' fa-spin ';
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "card text-center single-product" }, [
    _c("a", { attrs: { href: _vm.url } }, [
      _c("img", {
        staticClass: "card-img-top product-image",
        attrs: {
    ...
    _c("div", { staticClass: "card-body" }, [
      _c("br"),
      _vm._v(" "),
      _c("small", { staticClass: "text-left text-muted pull-left" }, [
      ...
      _c("p", { staticClass: "card-text" }, [
        ...
        _c(
          "span",
          {
            ...
            staticClass: "text-info text-muted",
            on: { click: _vm.showDescription }
          },
          [_vm._v("Show More....")]
        ),
        _vm._v(" "),
      ...
      _c(
        ...
        _vm._l(_vm.product.tags, function(tag) {
          return _c(
            ...
            {
              key: tag.id,
              staticClass: "tag badge badge-info btn",
              attrs: { "data-toggle": "tooltip", title: tag.name },
              on: { mouseover: _vm.addSpinner, mouseout: _vm.removeSpinner }
            },
            [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5cffb051", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/productsMasonry.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f393320c", Component.options)
  } else {
    hotAPI.reload("data-v-f393320c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("08143e70", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f393320c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./productsMasonry.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f393320c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./productsMasonry.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        filterProducts: function filterProducts() {
            ...
            $('.bootstrap-tagsinput').find('span.tag').each(function (e) {
                var text = $(this).text();
            ...
            if (!(self.selectedTags.trim() == '' && self.selectedName.trim() == '')) {
                ...
                this.productsFiltered = this.products.filter(function (product) {
                    ...
                    if (self.selectedTags.trim() != '') {
                        ...
                        try {
                            for (var _iterator = product.tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (self.selectedCategories.length != 0) {
                ...
                this.productsFiltered = this.productsFiltered.filter(function (product) {
                    ...
                    try {
                        for (var _iterator2 = product.categories[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var pCategory = _step2.value;
                            var _iteratorNormalCompletion3 = true;
                            var _didIteratorError3 = false;
                            var _iteratorError3 = undefined;

                            try {
                                for (var _iterator3 = self.selectedCategories[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                                    var sCategory = _step3.value;
        ...
        runPopover: function runPopover() {
            //Hide the tooltips
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        _c("div", { staticClass: "row my-3 form-group" }, [
          _c("div", { staticClass: "col-lg-4 col-sm-6" }, [
            _c(
              "select",
              {
                ...
                staticClass: "selectpicker w-100",
                attrs: {
                  name: "categories[]",
                  id: "categories",
                  multiple: "",
                  "data-style": "form-control btn-inverse text-white"
                },
                on: {
                  change: [
                    function($event) {
          ...
          _c("div", { staticClass: "col-lg-4 col-sm-6" }, [
            _c("input", {
              ...
              attrs: {
                placeholder: "Filter By Product's Name",
                id: "name",
                type: "text",
                name: "name"
              },
              ...
              on: {
                keyup: function($event) {
                  ...
                  return _vm.filterProducts($event)
                },
          ...
          _c(
            ...
            {
              staticClass:
                "col-lg-5 col-sm-4 text-center align-self-center my-2"
            },
            [
              _c(
                "h6",
                {
                  staticClass: "btn ",
                  attrs: { "data-toggle": "tooltip", title: "Sort" },
                  on: { click: _vm.sortByDate }
                },
                [
                  _c("i", { staticClass: "fa fa-sort icon-filter" }),
                  _vm._v("  " + _vm._s(_vm.orderByDateAscMsg) + " ")
                ]
              ),
              _vm._v(" "),
              _c("br"),
              ...
              _c(
                ...
                {
                  staticClass: "btn",
                  attrs: { "data-toggle": "tooltip", title: "Shuffle!" },
                  on: { click: _vm.shuffle }
                },
                [
                  _c("i", { staticClass: "fa fa-random icon-filter" }),
                  _vm._v(" Shuffle!")
                ]
              )
            ]
          ...
          _c(
            ...
            {
              staticClass:
                "col-lg-4 col-sm-6 mx-auto text-center align-self-center"
            },
            [
              _c(
                "button",
                {
                  staticClass: "btn btn-outline-info btn-md",
                  on: { click: _vm.filterProducts }
                },
                [
                  _c("i", { staticClass: "fa fa-search icon-filter" }),
                  _vm._v(" Filter ")
                ]
              )
            ]
      ...
      _c(
        "transition",
        { attrs: { name: "fade-slide", appear: "", mode: "in-out" } },
        [
          _c(
            "div",
            {
              ...
              staticClass: "col-lg-5 col-sm-12 alert alert-warning mx-auto"
            },
            [
              _c("h4", { staticClass: "alert-heading text-center" }, [
                _c("strong", [_vm._v(" No Results with the given filters ")]),
                _vm._v("!")
              ])
            ]
          )
      ...
      _c(
        "div",
        { staticClass: "card-columns product-grid" },
        [
          _c(
            "transition-group",
            { attrs: { appear: "", name: "fade-slide", mode: "in-out" } },
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      "div",
      {
        staticClass: "col-lg-6 col-sm-8 text-center align-self-center p-1 my-2",
        attrs: { "data-toggle": "tooltip", title: "Filter by Price" }
      },
      [
        _c("h6", [
          _vm._v("Filter by price "),
          _c("i", { staticClass: "fa fa-money icon-filter" })
        ]),
        _vm._v(" "),
        _c("input", { attrs: { type: "text", id: "price_range" } })
      ]
    )
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f393320c", module.exports)
  }
}
